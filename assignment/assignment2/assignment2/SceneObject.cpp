...
glm::vec3 SceneObject::lighting(glm::vec3 lightPos, glm::vec3 viewVec, glm::vec3 hit, float diffuseTerm1, float specularTerm1)
{
	float ambientTerm = 0.2;
	float diffuseTerm = diffuseTerm1;
	float specularTerm = specularTerm1;
...
float SceneObject::getDiffuseTerm()
{
	return diffuseTerm;
}

float SceneObject::getSpecularTerm()
{
	return specularTerm;
}