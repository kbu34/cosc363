...
//                                 CubePatches.cont, CubePatches.eval
//  ========================================================================
...
//Timer callback to update rotation angle
...
void display()
{
	glm:: mat4 mvpMatrix = glm::rotate(projView, angle*CDR, glm::vec3(0.0, 1.0, 0.0));  //rotation matrix mupltiplied by projetion-view matrix
